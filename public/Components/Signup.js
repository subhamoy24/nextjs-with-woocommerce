...
const Signup=()=>{
  ...
  <Wrapper>
      ...
      <RightWrapper>
          ...
          {success?<SubmitButt> successfully signed up </SubmitButt>:""}
          {fail?<FailButt> there is some issue while signed up </FailButt>:""}
          <div style={{display:"flex",width:"100%" ,justifyContent:"space-between"}}>
             <div style={{display:"flex",width:"47%" ,flexDirection:"column"}}>
                 <span style={{marginBottom:"7px"}}>First Name</span>
                 <Name  value={firstname} onChange={handleFirstName}/>
             </div>
             <div style={{display:"flex",width:"47%" ,flexDirection:"column"}}>
                 <span style={{marginBottom:"7px"}}>Last Name</span>
                 <Name value={lastname} onChange={handleLastName}/>
             </div>
            </div>
          <UserName value={email}  placeholder="email" onChange={handleEmail}/>
          <UserName value={password}  placeholder="password" onChange={handlePassword}/>
          <UserName value={retypepassword}  placeholder="retype password" onChange={handleRetypePassword}/>
          <SubmitButt type="submit">sign up</SubmitButt>
          </form>
      </RightWrapper>
  </Wrapper>)
}
